                    ...
                    <v-list-item v-for="volume in volumes" :key="volume.id">
                      ...
                      <v-list-item-action>
                        <v-btn
                          ...
                          color="blue"
                          text
                          :to="`/admin/manga/volume/episodes/${volume.id}/${manga.id}/${$route.params.aid}`"
                        >
...
export default {
  ...
  methods: {
    ...
    async getInfos() {
      ...
      await axios
        .get(`/admin/manga/setting/data/${id}`)
        .then((resp) => {
    ...
    async getGenres() {
      ...
      const id = this.$route.params.id;
      await axios.get(`/admin/manga/getGenre/${id}`).then((resp) => {
    ...
    async deleteGenre(id) {
      ...
      await axios
        .post(`/admin/manga/getGenre/delete/${id}`, formData)
        .then((resp) => {
          this.getGenres();
          this.cardLoading = false;
        })
    ...
    async deleteVolume(id) {
      ...
      formData.append("_method", "DELETE");
      await axios
        .post(`/admin/manga/getVolume/${id}/${this.$route.params.id}`, formData)
        .then((resp) => {
          this.getVolume();
          this.cardLoading = false;
        })
